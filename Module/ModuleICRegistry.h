...
{
  public:
    ModuleIC* getModuleICByIndex(const unsigned char index);
    void setModuleICByIndex(const unsigned char index, ModuleIC* ic);
    ModuleIC* invalid();
    unsigned char size();
...
inline ModuleIC* ModuleICRegistry::getModuleICByIndex(const unsigned char index)
{
...
inline void ModuleICRegistry::setModuleICByIndex(const unsigned char index, ModuleIC* ic)
{
  icMap[index] = ic;
}
